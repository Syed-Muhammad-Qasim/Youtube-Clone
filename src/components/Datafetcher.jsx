...
const Datafetcher = () => {
  ...
  const URL= "https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=50&regionCode=IN&key=AIzaSyCXHWcJ5d7XQ-cxmNqVem5oaWPYN8H2DpE"
      ...
      <div className="flex flex-col  flex-wrap   px-10 py-4 gap-4   md:flex-row ">
        {dataVar.map((item,index)=>{
          return(
            ...
            <div key={index} className=" bg-gray-100 h-[75vw] w-full   hover:bg-gray-300 cursor-pointer rounded-xl md:h-[240px] md:w-[350px]   lg:h-[210px]     lg:w-[275px] xl:w-[285px] xl:h-[230px] ">
          <img
          ...
          <h2 className="text-[2vw] pl-4 md:text-[10px] lg:text-[9px]">{dataVar[0]?.snippet.channelTitle}</h2>
          <div className=" flex gap-2 text-[2vw] pl-4 md:text-[10px] lg:text-[9px]">
          <h2>{CountConverter(item?.statistics.viewCount)} Views</h2>
